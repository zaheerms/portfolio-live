...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Mohamed Zaheerudeen";
...
function showSkills(skills) {
    ...
    skills.forEach(skill => {
        ...
        <div class="bar">
              <div class="info">
                <img src=${skill.icon} alt="skill" height="70" width="70" />
        ...
        <div class="box tilt">
            ...
            <div class="content">
                ...
                <div class="desc">
                    <p>${project.desc}</p>
                    <div class="btns">
                        <a href="${project.links.info}" class="btn" target="_blank"><i class="fas fa-eye"></i> More Info </a>
